...
const RoundedServiceCart = dynamic(
  () => import("../../src/Components/DashboardCompo/RoundedServiceCart"),
  {
    ssr: false,
  }
);
const Dashboard = (props) => {
  ...
  useEffect(() => {
    setLoading(true);
    const allUrl = [
      axios.get("https://jhon-portfolio-server.vercel.app/totalUser"),
      axios.get("https://jhon-portfolio-server.vercel.app/totalCategories"),
      axios.get("https://jhon-portfolio-server.vercel.app/blogTotalLC"),
      axios.get("https://jhon-portfolio-server.vercel.app/last7blog"),
      axios.get("https://jhon-portfolio-server.vercel.app/blogCount"),
    ];
    Promise.all(allUrl).then((res) => {
      ...
      res[3].data.forEach((single) => {
        lastBlogs = [
          ...lastBlogs,
          { ...single, date: "Date: " + new Date(single.date).getDate() },
        ];
      });
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={3}>
          <Box sx={{ p: 2, background: "rgb(17 24 39)" }}>
            ...
            <h2
              variant="h5"
              className="text-center p-4 text-white text-4xl"
              gutterBottom
            >
              <CountUp end={blogLC.love} />
            </h2>
        ...
        <Grid item xs={12} md={3}>
          <Box sx={{ p: 2, background: "rgb(17 24 39)" }}>
            ...
            <h2 className="text-center text-white p-4 text-4xl" gutterBottom>
              <CountUp end={blogLC.comment} />
            </h2>
        ...
        <Grid item xs={12} md={3}>
          <Box sx={{ p: 2, background: "rgb(17 24 39)" }}>
            ...
            <h2
              className="text-center text-4xl p-4 text-white"
              variant="h5"
              gutterBottom
            >
              <CountUp end={categories} />
            </h2>
        ...
        <Grid item xs={12} md={3}>
          <Box sx={{ p: 2, background: "rgb(17 24 39)" }}>
            ...
            <h2
              className="text-center p-4 text-4xl text-white"
              variant="h5"
              gutterBottom
            >
              <CountUp end={users} />
