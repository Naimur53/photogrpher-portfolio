        ...
        if (scrollValue >= 7) {
            if (homeBlog?.length) {
                if (window.innerWidth <= 600) {
                    wrapper.current.style.transform = `translate3d(0px, -${(scrollValue - 7) * 300}px, 0px)`
                    wrapper2.current.style.transform = `translate3d(0px, ${(scrollValue - 7) * 200}px, 0px)`
                } else {
                    wrapper.current.style.transform = `translate3d(0px, -${(scrollValue - 7) * 600}px, 0px)`
                    wrapper2.current.style.transform = `translate3d(0px, ${(scrollValue - 7) * 600}px, 0px)`
                }
